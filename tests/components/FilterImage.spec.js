...
describe("FilterImage.vue", () => {
    ...
    beforeEach(() => {
        const createElement = document.createElement.bind(document); 0
    ...
    test("uploadImageOCR method online", () => {
        ...
        const spyCreateTransaction = jest.spyOn(store.actions.transaction, 'createTransaction')
    ...
    test("generateImage method ", () => {
        ...
        expect(wrapper.vm.generateImage()).toEqual("data:image/png;base64, iVBORw0")
